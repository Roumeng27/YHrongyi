        ...
        <div class="pageWrapper">
            ...
            <div class="pick_input" >
                ...
                <div class="noteItem">
                    ...
                    <div class="write_input" >
                        <el-input v-model="number" placeholder="请输入内容" clearable></el-input>
                    </div>
                </div>
                                        ...
                                        <div class="edit_list">
                                            <div class="noteBox">
                                                <div class="noteItem">
                                                    ...
                                                    <div class="write_item">
                                                        <el-select v-model="recommendFirst">
                                                        <el-option label="区域一" v-for="item in validData" :key="item.bidInforId" :label="item.companyName" :value="item.bidInforId"></el-option>
                                                        </el-select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="noteBox">
                                                <div class="noteItem">
                                                    ...
                                                    <div class="write_item">
                                                        <el-select v-model="recommendSecond">
                                                        <el-option label="区域一" v-for="item in validData" :key="item.bidInforId" :label="item.companyName" :value="item.bidInforId"></el-option>
                                                        </el-select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="noteBox">
                                                <div class="noteItem">
                                                    ...
                                                    <div class="write_item">
                                                        <el-select v-model="recommendThird">
                                                            <el-option label="区域一" v-for="item in validData" :key="item.bidInforId" :label="item.companyName" :value="item.bidInforId"></el-option>
                                                        </el-select>
                                                    </div>
                                                </div>
		...
		methods:{
            ...
            getselectInfo(){
                ...
                this.$axios({
                    ...
                    if(res.data.status == 200){
                        this.recommendFirst =  res.data.data.recommendFirst;
                        this.recommendSecond =  res.data.data.recommendSecond;
                        this.recommendThird =  res.data.data.recommendThird;
                    }else{
                        console.log(res.data.msg);
                    }
                }).catch(err=>{
